...
export default function Page() {
  ...
  const incomingCount = activeOrders.filter(
    (o) => o.status === "incoming",
  ).length;
      ...
      <main className={styles.main}>
              ...
              <div className={styles.kanbanColumn}>
                <div className={styles.columnHeader}>
                  <div className={styles.columnHeaderTitle}>
                    ...
                    <h3 className={styles.columnTitleText}>INCOMING</h3>
                  </div>
                    ...
                    Array.from({ length: 2 }).map((_, idx) => (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            borderTop:
                              "1px solid var(--color-border-hairline, #e6dfd8)",
                            paddingTop: "0.75rem",
                            marginTop: "0.5rem",
                          }}
                        >
              ...
              <div className={styles.kanbanColumn}>
                <div className={styles.columnHeader}>
                  <div className={styles.columnHeaderTitle}>
                    ...
                    <h3 className={styles.columnTitleText}>PREPARING</h3>
                  </div>
                  <span className={styles.columnCount}>
              ...
              <div className={styles.kanbanColumn}>
                <div className={styles.columnHeader}>
                  <div className={styles.columnHeaderTitle}>
                    ...
                    />
                    <h3 className={styles.columnTitleText}>READY</h3>
                  </div>
                  <span className={styles.columnCount}>
            ...
            {activeFilter === "Completed" && (
              <div
                style={{
                  ...
                  backgroundColor: "var(--color-surface-card, #efe9de)",
                  borderRadius: "12px",
                  border: "1px solid var(--color-border-hairline, #e6dfd8)",
                }}
              >
                <h3
                  style={{
        ...
        <div className={styles.summaryBar}>
          <div className={styles.metricsCol}>
            <h4 className={styles.summarySectionTitle}>TODAY'S METRICS</h4>
            <div className={styles.metricsGrid}>
              ...
              <div>
                <span className={styles.metricLabel}>Avg Ticket Time</span>
          ...
          <div className={styles.completedSection}>
            <div className={styles.completedHeader}>
              <h4 className={styles.summarySectionTitle}>RECENTLY COMPLETED</h4>
              <a
              ...
              {completedOrders.slice(0, 3).map((o) => (
                <div key={o.id} className={styles.miniCard}>
                  <div className={styles.miniCardHeader}>
                    <span className={styles.miniCardId}>#{o.id}</span>
                    <span className={styles.miniCardTable}>{o.table}</span>
                  </div>
                  <div className={styles.miniCardPrice}>{o.price}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      >
        ...
        >
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="new-order-table">
              Select Table
            </label>
            {orderableTables.length > 0 ? (
              <select
          ...
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="new-order-size">
              Party Size
            </label>
            <select
              id="new-order-size"
          ...
          <div className={modalStyles.formGroup}>
            ...
            <div className={styles.menuItemsGrid}>
              {menuItems
                .filter((mi) => mi.category === modalCategory && mi.isActive)
                .map((item) => {
          ...
          <div className={modalStyles.footer}>
            ...
            <button
              ...
              disabled={
                orderableTables.length === 0 || selectedItemsList.length === 0
              }
              style={
                orderableTables.length === 0 || selectedItemsList.length === 0
