...
export default function ServicePage() {
  ...
  const getTableGrandTotal = (tableId) => {
    ...
    const completedTableOrders = completedOrders.filter(
      (o) => o.table === tableId,
    );
  ...
  const handleCloseBill = () => {
    ...
    const allTableOrders = [
      ...orders.filter((o) => o.table === billTableId),
      ...completedOrders.filter((o) => o.table === billTableId),
    ];
    const subtotal = allTableOrders.reduce((sum, o) => {
      if (!o.price) return sum;
      const numericPrice = parseFloat(o.price.replace(/[^\d.-]/g, "")) || 0;
      ...
      <div className={styles.contentWrapper}>
        ...
        <section className={styles.kpiGrid}>
          ...
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiContent}>
              <h3 className={styles.kpiValue}>$14,280</h3>
            ...
            <div className={styles.progressBarContainer}>
              <div
                className={styles.progressBarFillTertiary}
                style={{ width: "78%" }}
              />
            </div>
          </div>
          ...
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiContent}>
              ...
              <span className={styles.kpiTrendMuted}>Avg 42m/table</span>
            </div>
          ...
          {/* KPI 3 */}
          <div className={styles.kpiCard}>
            <p className={styles.kpiLabel}>TABLES OCCUPIED</p>
            <div className={styles.kpiContent}>
              <h3 className={styles.kpiValue}>24/32</h3>
              <span className={styles.kpiTrendAmber}>75% Capacity</span>
            </div>
            <div className={styles.progressBarContainer}>
              <div
          ...
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiContent}>
              <h3 className={styles.kpiValue}>$185.50</h3>
              <span className={styles.kpiTrend}>
                <ArrowUp size={14} /> $12
              </span>
            </div>
        ...
        <section className={styles.mainGrid}>
          ...
          <div className={styles.liveOrdersCol}>
            <div className={styles.sectionHeader}>
              <h4 className={styles.sectionTitle}>Live Orders Pipeline</h4>
              <Link
                href="/orders"
            ...
            <div className={styles.pipelineGrid}>
                    ...
                    .map((o) => (
                      ...
                      >
                        <div className={styles.orderCardHeader}>
                          <span className={styles.orderTable}>{o.table}</span>
                          <span
                ...
                <div className={styles.orderList}>
                  {orders
                    ...
                    .map((o) => (
                      <div
                        key={o.id}
                        className={styles.orderCardPreparing}
                        onClick={() => cycleOrderStatus(o.id)}
                        style={{ cursor: "pointer" }}
                      >
                        <div className={styles.orderCardHeader}>
              ...
              <div className={styles.pipelineColumn}>
                <p className={styles.pipelineColumnHeader}>
                  <span
                    className={`${styles.columnDot} ${styles.bgTertiary}`}
                  />{" "}
                ...
                <div className={styles.orderList}>
                  {orders
                    ...
                    .map((o) => (
                      <div
                        key={o.id}
                        className={styles.orderCardReady}
                        onClick={() => cycleOrderStatus(o.id)}
                        style={{ cursor: "pointer" }}
                      >
                        <div className={styles.orderCardHeader}>
                  ...
                  {reservations.map((r) => (
                    ...
                    >
                      <div className={styles.reservationGuestInfo}>
                        ...
                        <p className={styles.guestParty}>{r.details}</p>
                      </div>
                      <div
                        className={styles.reservationTime}
                        suppressHydrationWarning
                      >
                        {formatTimeTo12Hour(r.time)}
                      </div>
          ...
          <div className={styles.darkBandGrid}>
            ...
            <div>
              <div className={styles.darkBandHeader}>
                <h4 className={styles.darkBandTitle}>Top Menu Sellers</h4>
              ...
              <div className={styles.sellersList}>
                <div className={styles.sellerItem}>
                  ...
                  <div className={styles.sellerProgressContainer}>
                    <div
                      className={styles.sellerProgressFill}
                      style={{ width: "92%" }}
                    />
                  </div>
                </div>
            ...
            <div>
              ...
              <div className={styles.vipActivityList}>
                ...
                <div className={styles.vipActivityItem}>
                  <div className={styles.vipAvatarTertiary}>MC</div>
                  <div>
                    <p className={styles.vipActivityText}>
                      Marie Curie{" "}
                      <span className={styles.vipActivityAction}>
                ...
                <div className={styles.vipActivityItemLast}>
                  <div className={styles.vipAvatarOutline}>RK</div>
                  <div>
                    <p className={styles.vipActivityText}>
                      Robert King{" "}
                      <span className={styles.vipActivityAction}>joined</span>{" "}
                      Loyalty Platinum
                    </p>
                    <p className={styles.vipActivityMeta}>
        ...
        <section className={styles.actionsGrid}>
          <button className={styles.actionCard}>
            ...
            <div>
              <h5 className={styles.actionTitle}>Take Reservation</h5>
              <p className={styles.actionDesc}>Instant floor plan booking</p>
            </div>
          </button>
          <button className={styles.actionCard}>
            <div className={styles.actionIcon}>
            ...
            <div>
              <h5 className={styles.actionTitle}>Guest Campaign</h5>
              <p className={styles.actionDesc}>Blast VIP special offers</p>
            </div>
          </button>
          <button className={styles.actionCard}>
            <div className={styles.actionIcon}>
      ...
      {isBillModalOpen &&
        ...
        (() => {
          ...
          const subtotal = allTableOrders.reduce((sum, o) => {
            if (!o.price) return sum;
            const numericPrice =
              parseFloat(o.price.replace(/[^\d.-]/g, "")) || 0;
            return sum + numericPrice;
          }, 0);
              ...
              <div className={modalStyles.form}>
                <div className={styles.billCustomerCard}>
                  <div>
                    ...
                    <p className={styles.billCustomerName}>
                  ...
                  {seatedCustomer && (
                    <span
                      className={
                        seatedCustomer.tier === "Platinum"
                          ? styles.billCustomerTierPlatinum
                          : styles.billCustomerTier
                      }
                    >
                      {seatedCustomer.tier}
                    </span>
