...
export default function Header({ onMenuToggle }) {
  ...
  const setActiveModal = (type) =>
    type ? UIService.openModal(type) : UIService.closeModal();
  ...
  const handleWalkInSubmit = (e) => {
    ...
    if (walkInTab === "new" && walkInName.trim()) {
      ...
      const newCust = {
        ...
        email:
          walkInEmail.trim() ||
          `${walkInName.trim().toLowerCase().replace(/\s+/g, ".")}@example.com`,
    ...
    <>
            ...
            {isCreateMenuOpen && (
              <div className={styles.dropdownMenu}>
                <button
                  ...
                  onClick={() => handleCreateAction("reservation")}
                >
                ...
                <button
                  className={styles.dropdownItem}
                  onClick={() => handleCreateAction("walk-in")}
                >
                ...
                <button
                  className={styles.dropdownItem}
                  onClick={() => handleCreateAction("shift-note")}
                >
      ...
      >
        ...
        >
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="guest-name">
              Guest Name
            </label>
            {resCustomerId ? (
              <div className={styles.linkedBadge}>
                <div className={styles.linkedInfo}>
                  ...
                  <span className={styles.linkedGuestMeta}>
                    {customers.find((c) => c.id === resCustomerId)?.phone} •{" "}
                    {customers.find((c) => c.id === resCustomerId)?.tier}{" "}
                    Segment
                  </span>
                </div>
                <button
          ...
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="party-size">
              Party Size
            </label>
            <select
              id="party-size"
          ...
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="special-notes">
      ...
      >
        <form
          ...
          className={modalStyles.form}
          id="seat-walk-in-form"
        >
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="walk-in-table">
          ...
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="walk-in-size">
              Party Size
            </label>
            <select
              id="walk-in-size"
                ...
                {walkInCustomerId ? (
                  <div className={styles.linkedBadge}>
                    <div className={styles.linkedInfo}>
                      ...
                      <span className={styles.linkedGuestMeta}>
                        {
                          customers.find((c) => c.id === walkInCustomerId)
                            ?.phone
                        }{" "}
                        •{" "}
                        {customers.find((c) => c.id === walkInCustomerId)?.tier}
                      </span>
                    </div>
                    <button
                      type="button"
                        ...
                        {customers
                          .filter(
                            (c) =>
                              c.name
                                .toLowerCase()
                                .includes(walkInSearchQuery.toLowerCase()) ||
      ...
      >
        <form
          ...
          className={modalStyles.form}
          id="new-shift-note-form"
        >
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="note-author">
              Author / Role
            </label>
            <select
              id="note-author"
            ...
            >
              ...
              {(staff.filter((s) => s.onShift).length > 0
          ...
          <div className={modalStyles.formGroup}>
            <label className={modalStyles.label} htmlFor="note-content">
              Note Content
            </label>
            <textarea
              id="note-content"
